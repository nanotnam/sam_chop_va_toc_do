...
YELLOW_LOWER = np.array([0, 0, 0], dtype=np.uint8)
YELLOW_UPPER = np.array([0, 0, 0], dtype=np.uint8)
...
# Save results
cv2.imwrite("accumulated_markings.png", accumulation_map)
cv2.imwrite("final_lane_markings.png", final_mask)
